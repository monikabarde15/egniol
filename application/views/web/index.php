  ...
  <div>
    <div class="jsx-1d2245041db79278 absolute w-full lg:top-24 sm:top-60 md:top-56 top-48 md:block hidden">
      <div class="jsx-1d2245041db79278 relative  sm:max-w-[1400px] mx-auto">
        <div class="jsx-1d2245041db79278 absolute top-20
              left-0 sm:left-4 md:left-8
              transition-all duration-500 ease-out 
             scale-100 z-10 lg:z-20
    ...
    "><img alt="affordable-land" loading="lazy" decoding="async" data-nimg="fill"
      ...
      overflow-hidden flex items-center justify-center
    "><img alt="Merger &amp; Acquisition" loading="lazy" decoding="async" data-nimg="fill"
                  class="transition-transform duration-700 ease-out transform hover:scale-105 object-contain hidden md:block"
                  style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent"
                  sizes="100vw"
    ...
    <div class="font-custom1 overflow-x-hidden">
      <div></div>
      <div class="relative flex flex-col justify-between items-center text-center md:pt-10">
        <div
          class="absolute inset-0 -z-10 bg-cover bg-center bg-no-repeat  gradient-header h-[520px] md:h-[632px] xl:h-[732px]"
          style="background-position:center;background-size:cover;background-repeat:no-repeat"></div>
        <div class="flex flex-col justify-center items-center w-full">
          <div class="flex flex-col justify-center items-center mt-32  z-10"><button>
              <h1 class="md:text-[3.9rem] text-4xl font-CustomSemiBold leading-10 md:leading-none text-[#FFFFFF]">Hum
                Badhayenge <br /> Aapka Business</h1>
              <p
                class="text-center md:text-start text-sm lg:text-[1.5rem] font-custom1 md:mt-6 mt-4  mx-4 text-[#FFFFFF] ">
                One
                stop solution for MSMEs and Startups</p>
            </button><button
              class="bg-[#03518F] px-28 py-3 text-[15px] rounded-2xl text-white md:mt-10 mt-4 block md:hidden"><span>Get
                Started</span></button><button
          ...
          <div class="w-full min-h-[150px] md:hidden">
            <div class="overflow-hidden cursor-grab min-h-[150px]">
        ...
        bg-[#03518F]
          ...
          md:w-[260px] hidden md:flex

          "></div>
          </div>
          <div class="w-full pt-4 pb-8 flex justify-center md:hidden flex-col">
            <h2 class="text-3xl font-CustomSemiBold mb-4">Real <span class="text-[#03518F]">Stories</span>, Real
              <br /><span class="text-[#E74322]">Success</span></h2>
            <div class="swiper w-full">
              <div class="swiper-wrapper">
                <div class="swiper-slide cursor-pointer relative h-[250px] w-[150px] md:w-[190px]">
                  <div class="relative transform transition-all duration-500 h-[250px] w-full"><img
                    ...
                    <div class="absolute inset-0 flex items-center justify-center  rounded-xl"><svg width="48"
                        ...
                        <path d="M34 24.5L19 32.5V16.5L34 24.5Z" fill="white"></path>
                      </svg></div>
                  </div>
                </div>
                <div class="swiper-slide cursor-pointer relative h-[250px] w-[150px] md:w-[190px]">
          ...
          <div class="mt-12 md:mt-0 w-full md:block hidden">
            <div class="w-full flex flex-col items-center justify-center md:gap-8 ">
              <h2 class="md:text-5xl text-4xl w-[70%] font-CustomSemiBold mt-12 text-center">Don&#x27;t
                just take our word</h2>
          ...
          <section class="min-w-0 w-full relative hidden md:block">
            <div class="slick-slider md:mx-8 mx-4 mb-12 slick-initialized" dir="ltr"><button
                class="absolute top-1/2 -translate-y-1/2 z-10 bg-[#03518f] text-white rounded-full p-2 shadow-md transition-all left-0 -ml-4"><svg
                  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-chevron-left w-5 h-5 text-white ">
              ...
              <div class="slick-list">
                <div class="slick-track" style="width:400%;left:-100%">
                  <div data-index="-6" tabindex="-1" class="slick-slide slick-cloned" aria-hidden="true"
                    ...
                    <div>
                      <div class="px-4 cursor-grab active:cursor-grabbing" tabindex="-1"
                  ...
                  <div data-index="-1" tabindex="-1" class="slick-slide slick-cloned" aria-hidden="true"
                    ...
                    <div>
                      <div class="px-4 cursor-grab active:cursor-grabbing" tabindex="-1"
                        style="width:100%;display:inline-block"><img alt="slide-8" draggable="false" loading="lazy"
                          width="200" height="200" decoding="async" data-nimg="1"
                          class="w-full object-cover lg:h-auto rounded-2xl border-2 border-gray-500/20 shadow-lg "
                          style="color:transparent"
                  ...
                  <div data-index="0" class="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false"
                    style="outline:none;width:4.166666666666667%">
                    <div>
                      <div class="px-4 cursor-grab active:cursor-grabbing" tabindex="-1"
                ...
                class="absolute top-1/2 -translate-y-1/2 z-10 bg-[#03518f] text-white rounded-full p-2 shadow-md transition-all right-0 -mr-4"><svg
                  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-chevron-right w-5 h-5 text-white">
                  <path d="m9 18 6-6-6-6"></path>
                </svg></button>
            </div>
          </section>
          <div class="bg-blue-50 pt-8 w-full md:px-10 px-6 pb-10 md:hidden block">
            <h2 class="md:hidden text-3xl font-CustomSemiBold text-center mb-10">Why
              Us?</h2>
            <div class="swiper">
              <div class="swiper-wrapper">
          ...
          <div id="mostpopular" class="bg-[#F8F9FE] w-full xl:px-48 lg:px-10 flex justify-center items-center">
            <div class="hidden md:block">
              <h2 class="text-4xl font-CustomSemiBold text-center py-8">Most
                Popular Services (Funding)</h2>
              <div class="grid md:grid-cols-3 grid-cols-2 md:gap-16 gap-4 mx-4">
                <div class="col-span-1">
                  <div
                    class="h-full hover:-translate-y-3 flex flex-col justify-between hover:border-[#EE4523] border-2 transition-all duration-300 group hover:bg-[#fef8f7] bg-gradient-to-b from-[#FFFFFF] to-[#EAEDFC] rounded-lg shadow-xl">
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      <p class="lg:text-3xl text-xl  card-gradient-orange bebas-neue-regular">UP
                        TO</p>
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹1
                        cr</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">Seed
                        Support Scheme</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                      ...
                      <div class="relative inline-block w-full lg:w-1/2"><button
                          class="relative z-10 lg:py-2 py-1 xl:px-8 w-full lg:rounded-full rounded-b-lg bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                            ...
                            now</span>
                          <div
                            class="absolute inset-0 w-full h-full bg-white transform -translate-x-full false transition-transform duration-300 ease-in-out">
                          </div>
                        </button></div>
                    </div>
                  </div>
                ...
                <div class="col-span-1">
                  <div
                    ...
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      <p class="lg:text-3xl text-xl  card-gradient-orange bebas-neue-regular">UP
                        TO</p>
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹50
                        L</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">Grant
                        for Textile</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                ...
                <div class="col-span-1">
                  <div
                    ...
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      <p class="lg:text-3xl text-xl  card-gradient-orange bebas-neue-regular">UP
                        TO</p>
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹5
                        cr</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">MSME
                        Loans</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                ...
                <div class="col-span-1">
                  <div
                    ...
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      ...
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹1
                        cr</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">NBFC
                        Loans</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                      <img alt="egniolimage" loading="lazy" width="49" height="49" decoding="async" data-nimg="1"
                ...
                <div class="col-span-1">
                  <div
                    ...
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      <p class="lg:text-3xl text-xl  card-gradient-orange bebas-neue-regular">UP
                        TO</p>
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹2
                        CR</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">NAIFF
                        Loans</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                ...
                <div class="col-span-1">
                  <div
                    ...
                    <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                      <p class="lg:text-3xl text-xl  card-gradient-orange bebas-neue-regular">UP
                        TO</p>
                      <p class="xl:text-9xl text-6xl bebas-neue-regular card-gradient-orange">₹3
                        CR</p>
                      <h3 class="lg:text-lg text-[10px] font-custom1  pr-4">Funds
                        for SC, ST &amp; OBC Entrepreneurs</h3>
                    </div>
                    <div class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
            ...
            <div class="flex flex-col items-center md:hidden px-6 overflow-hidden">
              <h2 class="text-3xl font-CustomSemiBold text-center py-6 px-5">Most
                Popular Services (<span class="text-[#E74322]">Funding</span>)</h2>
              <div class="w-full">
                <div class="overflow-visible cursor-grab min-h-[166px]">
                  <div class="swiper">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div
                          class="md:h-full flex flex-col justify-between hover:border-[#EE4523] border-2 transition-all duration-300 group  rounded-2xl  mr-4 h-[166px] shadow-[10px_3px_15px_rgba(0,0,0,0.05)]">
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            <p class="lg:text-3xl text-sm card-gradient-orange">UP
                              TO</p>
                            <p
                              class="xl:text-9xl md:text-4xl text-xl uppercase font-CustomSemiBold card-gradient-orange mb-2">
                              ₹1
                              cr</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">Seed
                              Support Scheme</h3>
                          </div>
                          <div
                            class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                            <div class="relative inline-block w-full lg:w-1/2 group"><button
                                class="relative z-10 lg:py-2 py-1 xl:px-8 w-full lg:rounded-full rounded-b-lg bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden group-hover:text-[#03518F]"><span
                                  class="relative z-20 w-full text-white group-hover:text-[#03518F]">Avail
                                  now</span>
                                <div
                        ...
                        <div
                          ...
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            ...
                            <p
                              ...
                              ₹50
                              L</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">Grant
                              for Textile</h3>
                          </div>
                          <div
                            class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                        ...
                        <div
                          ...
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            ...
                            <p
                              ...
                              ₹5
                              cr</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">MSME
                              Loans</h3>
                          </div>
                          <div
                            class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                        ...
                        <div
                          ...
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            ...
                            <p
                              ...
                              ₹1
                              cr</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">NBFC
                              Loans</h3>
                          </div>
                          <div
                            class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                        ...
                        <div
                          ...
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            ...
                            <p
                              ...
                              ₹2
                              CR</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">NAIFF
                              Loans</h3>
                          </div>
                          <div
                            class="flex lg:justify-between lg:items-center bg-white lg:py-2 lg:px-4 rounded-b-lg w-full">
                        ...
                        <div
                          ...
                          <div class="pl-4 md:pt-8 pt-4 flex flex-col text-left mb-4">
                            ...
                            <p
                              ...
                              ₹3
                              CR</p>
                            <h3 class="lg:text-lg text-[9px] uppercase pr-4">Funds
                              for SC, ST &amp; OBC
                              Entrepreneurs</h3>
                          </div>
                          <div
          ...
          <div class="bg-blue-50 pt-8 w-full md:px-10 px-4  pb-16 hidden md:block">
            <div class="md:px-4">
              <h2 class="md:block hidden text-4xl font-CustomSemiBold text-center">Our
                Expertise helps your startup</h2>
              <h2 class="md:block hidden text-4xl font-CustomSemiBold text-center mb-10">grow
                at every stage</h2>
              <h2 class="md:hidden text-4xl font-CustomSemiBold text-center mb-10">Our
                Services</h2>
              <div class="grid grid-cols-2  md:grid-cols-4 gap-3 mx-2 mb-4">
                <div
                  class="md:h-[300px] flex flex-col justify-between bg-white md:p-6 rounded-md shadow-lg hover:shadow-xl md:hover:-translate-y-3 transition hover:border border-[#03518F] duration-500"
                  style="background:linear-gradient(to bottom, #ffffff 0%, #eaedfc 100%)">
                  <div>
                  ...
                  <div class="md:mt-auto mt-3">
                    <h3 class="lg:text-base text-base font-CustomSemiBold text-center">Business
                      Setup</h3>
                    <p
                      class="text-[#49484E] text-[10px]  sm:text-sm md:text-sm lg:text-[12px] text-center mb-2 mx-1 md:mx-auto overflow-hidden text-ellipsis line-clamp-2">
                      Company
                      Registrations, Certifications and more..</p>
                  </div>
                  <div class="flex justify-center items-center"><button
                      class="relative w-full z-10 md:py-2 xl: px-2 rounded-b-md md:rounded-3xl bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                        class="relative z-20 text-xs sm:text-sm md:text-lg text-white">Explore</span>
                      <div
                        class="absolute inset-0 w-full h-full bg-white transform -translate-x-full false transition-transform duration-300 ease-in-out">
                      </div>
                    </button></div>
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mx-2 mb-4">
                <div
                  class="md:h-[350px] flex flex-col justify-between bg-white md:p-6 rounded-md shadow-lg hover:shadow-xl md:hover:-translate-y-3 transition hover:border border-[#03518F] duration-500"
                  style="background:linear-gradient(to bottom, #ffffff 0%, #eaedfc 100%)">
                  <div>
                  ...
                  <div class="md:mt-auto mt-3">
                    <h3 class="lg:text-base text-base font-CustomSemiBold text-center">Affordable
                      Land for Business Setup</h3>
                    <p
                      class="text-[#49484E] text-[10px] sm:text-sm md:text-sm lg:text-[12px] text-center mb-2 mx-1 md:mx-auto overflow-hidden line-clamp-2">
                      Cost-effective
                      land for business growth</p>
                  </div>
                  <div class="flex justify-center items-center"><button
                      class="relative w-full z-10 md:py-2 xl: px-2 rounded-b-md md:rounded-3xl bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                        class="relative z-20 text-xs sm:text-sm md:text-lg text-white">Explore</span>
                ...
                <div
                  ...
                  <div class="md:mt-auto mt-3">
                    <h3 class="lg:text-base text-base font-CustomSemiBold text-center">Merger
                      &amp; Acquisition</h3>
                    <p
                      class="text-[#49484E] text-[10px] sm:text-sm md:text-sm lg:text-[12px] text-center mb-2 mx-1 md:mx-auto overflow-hidden line-clamp-2">
                      Unite,
                      Grow &amp; Enhance Business Value</p>
                  </div>
                  <div class="flex justify-center items-center"><button
                      class="relative w-full z-10 md:py-2 xl: px-2 rounded-b-md md:rounded-3xl bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                        class="relative z-20 text-xs sm:text-sm md:text-lg text-white">Explore</span>
                ...
                <div
                  ...
                  <div class="md:mt-auto mt-3">
                    <h3 class="lg:text-base text-base font-CustomSemiBold text-center">CRM</h3>
                    <p
                      class="text-[#49484E] text-[10px] sm:text-sm md:text-sm lg:text-[12px] text-center mb-2 mx-1 md:mx-auto overflow-hidden line-clamp-2">
                      Connect,
                      Engage &amp; Retain your Customers</p>
                  </div>
                  <div class="flex justify-center items-center"><button
                      class="relative w-full z-10 md:py-2 xl: px-2 rounded-b-md md:rounded-3xl bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                        class="relative z-20 text-xs sm:text-sm md:text-lg text-white">Explore</span>
                ...
                <div
                  ...
                  <div class="md:mt-auto mt-3">
                    <h3 class="lg:text-base text-base font-CustomSemiBold text-center">MSME
                      training</h3>
                    <p
                      class="text-[#49484E] text-[10px] sm:text-sm md:text-sm lg:text-[12px] text-center mb-2 mx-1 md:mx-auto overflow-hidden line-clamp-2">
                      Empower,
                      Upskill &amp; Grow Your MSME</p>
                  </div>
                  <div class="flex justify-center items-center"><button
                      class="relative w-full z-10 md:py-2 xl: px-2 rounded-b-md md:rounded-3xl bg-[#03518F] border border-[#03518F] transition-colors duration-300 overflow-hidden"><span
                        class="relative z-20 text-xs sm:text-sm md:text-lg text-white">Explore</span>
          ...
          <div class="bg-blue-50 py-8 w-full md:px-10 px-6 md:hidden block">
          ...
          <div id="partner-section"
            class="md:px-12 py-8 w-full bg-[#F8F9FE] md:bg-gradient-to-r from-white to-[#EAEDFC]">
            <h2 class="text-center md:text-5xl text-4xl font-CustomSemiBold hidden md:block">Our
              trusted Partners</h2>
            <h2 class="text-3xl font-CustomSemiBold text-center block md:hidden">Our
              <span class="text-[#E74322]">trusted</span>
              Partners
            </h2>
            <section class="hidden md:flex mt-20">
              <div class="w-1/4 flex justify-center items-center">
                <ul class="text-left flex flex-col gap-8">
                  <li class="cursor-pointer font-bold text-[#03518f]">Ecosystem
                    Partners</li>
                  <li class="cursor-pointer ">Business
                    Partners</li>
                  <li class="cursor-pointer ">Communication
                    Partner</li>
                  <li class="cursor-pointer ">Academic
                    Partner</li>
                </ul>
              </div>
              <section class="border-l-2 border-[#03518f] min-w-0 w-3/4 mr-auto justify-center items-center">
                <div class="pl-8"></div>
              </section>
            </section>
            <section class="md:hidden mt-10">
              <style data-emotion="css 1elhkxb">
                .css-1elhkxb {
                  overflow: hidden;
                  min-height: 48px;
                ...
                @media (max-width:599.95px) {
                  .css-1elhkxb .MuiTabs-scrollButtons {
                    display: none;
                  }
                }

                .css-1elhkxb .MuiTabs-indicator {
                  background-color: #E74322;
                }

                .css-1elhkxb .MuiTab-root {
                  color: black;
                }

                .css-1elhkxb .Mui-selected {
                  color: #03518F;
                }
              </style>
              <div class="MuiTabs-root css-1elhkxb">
                <style data-emotion="css 1anid1y">
                  .css-1anid1y {
                    position: relative;
                ...
                <div class="MuiTabs-scroller MuiTabs-fixed css-1anid1y" style="overflow:hidden;margin-bottom:0">
                  ...
                  <div class="MuiTabs-flexContainer css-k008qs" role="tablist">
                    <style data-emotion="css 1mgd0rq">
                      .css-1mgd0rq {
                      ...
                      .css-1mgd0rq.Mui-selected {
                        color: #1976d2;
                      }

                      .css-1mgd0rq.Mui-disabled {
                        color: rgba(0, 0, 0, 0.38);
                      }
                    </style>
                    <style data-emotion="css v57nml">
                      .css-v57nml {
                      ...
                      .css-v57nml::-moz-focus-inner {
                        border-style: none;
                      }

                      .css-v57nml.Mui-disabled {
                        pointer-events: none;
                        cursor: default;
                      }
                      ...
                      class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary MuiTab-fullWidth Mui-selected css-v57nml"
                      tabindex="0" type="button" role="tab" aria-selected="true">Ecosystem<style
                        data-emotion="css ttwr4n">
                        .css-ttwr4n {
                          position: absolute;
                          height: 2px;
                          bottom: 0;
                      ...
                      </style><span class="MuiTabs-indicator css-ttwr4n"></span></button><button
                      class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary MuiTab-fullWidth css-v57nml"
                      tabindex="-1" type="button" role="tab" aria-selected="false">Business</button><button
                      class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary MuiTab-fullWidth css-v57nml"
                      tabindex="-1" type="button" role="tab" aria-selected="false">Communication</button><button
                      class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary MuiTab-fullWidth css-v57nml"
                      tabindex="-1" type="button" role="tab" aria-selected="false">Academic</button>
                  </div>
                </div>
              </div>
              <div class></div>
          ...
          <div class="md:px-16 md:py-16  bg-white md:w-[90%] w-full">
            <h2 class="text-center md:text-5xl text-3xl font-CustomSemiBold m-4 md:mb-14 hidden md:block">We
              are making the headlines</h2>
            <h2 class="text-center md:text-5xl text-3xl font-semibold mt-6 mb-4 md:mb-14 block md:hidden">We
              are<!-- --> <span class="relative inline-block"><span
                  class="absolute inset-0 -skew-x-6 bg-[#04518E] px-4"></span><span
                  class="relative text-[#DEDEDE] font-bold px-3 py-4">making
            ...
            <div class="md:grid-cols-3 grid-cols-2 md:gap-16 gap-x-2 hidden md:grid"><a
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    A
                    Special Workshop For SC Entrepreneurs In
                    Ahmedabad</p>
                </div>
              </a><a
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    Changing
                    The Game: Egniol&#x27;s MSME Samvaad Leads The Way For
                    Indian MSMEs...</p>
                </div>
              </a><a
                href="https://www.republicworld.com/initiatives/bharat-sarkar-announces-india-s-rise-to-third-largest-startup-ecosystem-at-startup-mahakumbh/?amp=1">
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  <div
                    class="w-full text-center rounded-lg border hover:border-[#03518f] transition-all duration-300 ease-in-out relative card xl:h-[300px] md:h-[150px] h-[150px]">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    Companies
                    working alongside Government&#x27;s Vision to support
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    MSME
                    Expo 2024: How My MSME House by Egniol is Helping
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    Empowering
                    Startups - Egniol&#x27;s impact through the eyes of
                    40,000+ customers...</p>
                </div>
              </a><a
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    MSMEs
                    Take Center Stage at Vejalpur Startup Festival 2.0 as
                ...
                <div class="w-full flex flex-col justify-center items-center md:max-w-[400px] md:mx-auto">
                  ...
                  <p
                    class="hidden md:block text-[#212529] mt-2 text-center font-light w-full overflow-hidden text-ellipsis whitespace-pre-wrap font-custom1">
                    Egniol
                    Group of Companies recognised for its contribution to
                    Vejalpur Startup Festival 2.0</p>
                </div>
              </a></div>
          ...
          <div
            class="flex flex-wrap md:flex-col md:w-full gap-4 justify-center items-center py-6 md:py-10 bg-[#EAF3FE] m-6 md:m-0 rounded-2xl md:rounded-none ">
            <h2 class="text-3xl md:text-4xl font-CustomSemiBold md:mt-6 px-6 text-center"
              style="opacity:0;transform:translateY(30px)">Get started with
              Egniol today</h2>
            <p class="text-sm text-[#212529B2] mb-4 text-center w-[90%]" style="opacity:0;transform:translateY(30px)">
              Have a question or
              feedback? Fill out the form below and we&#x27;ll get back to you
              as soon as possible.</p>
            <div class="md:w-[60%] w-[90%]" style="opacity:0;transform:translateY(30px)">
              <form>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div class="flex flex-col"><input type="text" placeholder="Name"
                      class="p-3 md:p-2 md:border rounded-lg md:rounded border-[#CED4DA] drop-shadow-xl" name="name"
                      value /></div>
                  <div class="flex flex-col"><input type="tel" placeholder="Mobile no"
                      class="p-3 md:p-2 md:border rounded-lg md:rounded border-[#CED4DA] drop-shadow-xl" maxLength="10"
                      name="mobileNo" value /></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 md:mb-4">
                  <div class="flex flex-col"><input type="text" placeholder="Company"
                      class="p-3 md:p-2 md:border rounded-lg md:rounded border-[#CED4DA] drop-shadow-xl" name="company"
                      value /></div>
                  <div class="flex flex-col"><input type="email" placeholder="Email"
                      class="p-3 md:p-2 md:border rounded-lg md:rounded border-[#CED4DA] drop-shadow-xl" name="email"
                      value /></div>
                </div><button type="submit"
                  class="w-full text-white py-2 px-4 transition rounded-lg duration-300  md:mb-4 bg-[#03518F] hover:bg-[#03508fe3]">Send
                  message</button>
              </form>
            </div>
          </div>
